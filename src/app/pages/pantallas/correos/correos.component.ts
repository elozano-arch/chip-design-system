  ...
  plantillas: Plantilla[] = [
       ...
       ---------------------------------------------------------------- */
    {
      ...
      variables: [
        ...
        { name: '{{total_formularios}}', descripcion: 'Cantidad de formularios incluidos en el envío' },
    ...
    },
    {
      ...
      descripcion: 'La importación terminó sin deficiencias. La información queda cargada y se habilitan las validaciones locales. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario.',
      ...
      variables: [
        ...
        { name: '{{total_formularios}}', descripcion: 'Cantidad de formularios incluidos en el envío' },
        { name: '{{#formularios_exitosos}}', descripcion: 'Sección repetible: formularios sin deficiencias. Cada item usa {{nombre}}.' },
    ...
    },
    {
      ...
      descripcion: 'La importación terminó con deficiencias no bloqueantes. El usuario puede continuar, pero se le recomienda revisarlas. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario. La plantilla se elige por la regla "gana el peor estado": basta un formulario rechazado para que se envíe la versión rechazada.',
    ...
    },
    {
      ...
      descripcion: 'La importación fue rechazada por deficiencias bloqueantes. La información NO queda cargada; el usuario debe corregir el archivo y volver a importarlo. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario. La plantilla se elige por la regla "gana el peor estado": basta un formulario rechazado para que se envíe la versión rechazada.',
    ...
    },
    {
      ...
      descripcion: 'Las validaciones locales terminaron sin deficiencias. Se habilita el envío a validación central. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario.',
    ...
    },
    {
      ...
      descripcion: 'Las validaciones locales terminaron con deficiencias no bloqueantes. El usuario puede enviar a validación central, pero se le recomienda revisarlas. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario. La plantilla se elige por la regla "gana el peor estado": basta un formulario rechazado para que se envíe la versión rechazada.',
    ...
    },
    {
      ...
      descripcion: 'Las validaciones locales detectaron deficiencias bloqueantes. La categoría no avanza; el usuario debe reiniciar desde el proceso de importación. Cuando el envío trae varios formularios, este correo agrupa a todos: se envía uno solo con el desglose por formulario. La plantilla se elige por la regla "gana el peor estado": basta un formulario rechazado para que se envíe la versión rechazada.',
